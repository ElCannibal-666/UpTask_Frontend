  ...
  return (
    <>
      ...
      <p className="text-2xl font-light text-white mt-5">
        ...
        <span className=" text-white-500 font-bold"> crear tu cuenta</span>
      </p>
      ...
      <nav className="mt-10 flex flex-col space-y-4 text-white font-bold text-center">
        <Link to={"/auth/login"}>¿Ya tienes cuenta? Inciar Sesión</Link>
