...
import DeleteProjectModal from "@/components/projects/DeleteProjectModel";

// Funcion que nos ayuda a mostrar los datos de la base de datos en el Layout
    ...
    return (
      <>
        ...
        {data.length ? (
          <ul
            role="list"
            className="divide-y divide-gray-100 border hover:divide-y-8 border-gray-100 mt-10 bg-white shadow-lg"
          >
            {data.map((project) => (
              <li
                key={project._id}
          ...
          <p className="text-center py-10">
            ...
            <Link
              to={"/projects/create"}
              className="text-gray-500 hover:text-gray-700  font-bold cursor-pointer transition-colors"
            >
              Crear Proyecto
            </Link>
          </p>
